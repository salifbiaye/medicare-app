  ...
  return (
    <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
      <div className="flex flex-1 items-center space-x-2">
        ...
        <Button variant="default" onClick={() => router.push("/admin/hospitals/new")} className="h-8 px-2 lg:px-3">
        ...
        <Button variant="special" onClick={() => router.push("/admin/hospitals/import")} className="h-8 px-2 lg:px-3">
          <PlusIcon className="mr-2 h-4 w-4" />
          Importer
        </Button>
      </div>
