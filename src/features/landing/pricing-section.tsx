                ...
                <div className="mt-8 grid gap-6 md:mt-20 md:grid-cols-5 md:gap-0 ">
                    <div className="rounded-lg flex flex-col justify-between space-y-8 border p-6 md:col-span-2 md:my-2 md:rounded-r-none md:border-r-0 lg:p-10">
                        <div className="space-y-4">
                            ...
                            <Button asChild variant="outline" className="w-full hover:bg-gray-900">
                    ...
                    <div className=" rounded-lg border p-6 shadow-lg shadow-gray-950/5 md:col-span-3 lg:p-10 bg-zinc-900 ">
