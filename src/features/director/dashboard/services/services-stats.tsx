...
import { getServiceStatsAction } from "@/actions/service.action"
...
export function ServicesStats() {
    ...
    return (
        <div className="w-full">
            <div className="relative overflow-hidden bg-gradient-to-br from-green-600 to-emerald-700 rounded-xl shadow-lg">
                {/* Background pattern */}
                ...
                <div className="relative p-8 flex flex-col items-center text-white">
                    ...
                    <h3 className="text-lg font-medium mb-2 text-white/80">Total Services</h3>
            ...
            <span className="relative">
              {stats?.totalServices || 0}
                ...
                <span className="relative inline-flex rounded-full h-3 w-3 bg-white"></span>
                    ...
                    <p className="text-sm text-white/70">Services médicaux enregistrés</p>
